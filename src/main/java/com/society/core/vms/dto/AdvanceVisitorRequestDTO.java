...
/**
 * The data class for the ADVANCE_VISITOR_REQUEST object table.
 * 
 */
public class AdvanceVisitorRequestDTO implements Serializable {
	...
	public AdvanceVisitorRequestDTO() {
	}
